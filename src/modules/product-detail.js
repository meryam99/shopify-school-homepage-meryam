...
const product = {
  ...
  colors: {
    pink: {
      ...
      images: [
        { thumb: '/src/images/product__main-pink.png', full: '/src/images/product__main-pink.png', alt: 'Pink 1' },
        { thumb: '/src/images/product__main-pink-2.png', full: '/src/images/product__main-pink-2.png', alt: 'Pink 2' },
        { thumb: '/src/images/product__main-pink-3.png', full: '/src/images/product__main-pink-3.png', alt: 'Pink 3' },
        { thumb: '/src/images/product__main-pink-4.png', full: '/src/images/product__main-pink-4.png', alt: 'Pink 4' },
        { thumb: '/src/images/product__main-pink-5.png', full: '/src/images/product__main-pink-5.png', alt: 'Pink 5' },
      ],
      defaultSize: 'UK 6 (EU 39)',
    },
    black: {
      name: 'Black',
      swatchThumb: '/src/images/product__main-black-2.png',
      price: 290,
      sizes: ['UK 6.5', 'UK 7', 'UK 8', 'UK 9'],
      images: [
        { thumb: '/src/images/product__main-black-2.png', full: '/src/images/product__main-black-2.png', alt: 'Black 1' },
        { thumb: '/src/images/product__main-black.png', full: '/src/images/product__main-black.png', alt: 'Black 2' },
        { thumb: '/src/images/product__main-black-3.png', full: '/src/images/product__main-black-3.png', alt: 'Black 3' },
        { thumb: '/src/images/product__main-black-4.png', full: '/src/images/product__main-black-4.png', alt: 'Black 4' },
        { thumb: '/src/images/product__main-black-5.png', full: '/src/images/product__main-black-5.png', alt: 'Black 5' },
      ],
      defaultSize: 'UK 9',
    },
    white: {
      name: 'White',
      swatchThumb: '/src/images/product__main-white-3.png',
      price: 270,
      sizes: ['UK 7.5', 'UK 8', 'UK 9', 'UK 10'],
      images: [
        { thumb: '/src/images/product__main-white-3.png', full: '/src/images/product__main-white-3.png', alt: 'White 1' },
        { thumb: '/src/images/product__main-white-2.png', full: '/src/images/product__main-white-2.png', alt: 'White 2' },
        { thumb: '/src/images/product__main-white.png', full: '/src/images/product__main-white.png', alt: 'White 3' },
        { thumb: '/src/images/product__main-white-4.png', full: '/src/images/product__main-white-4.png', alt: 'White 4' },
        { thumb: '/src/images/product__main-white-5.png', full: '/src/images/product__main-white-5.png', alt: 'White 5' },
      ],
      defaultSize: 'UK 7.5',
    },
  },
